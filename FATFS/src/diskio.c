...
#define FLASH_SECTOR_COUNT 	1024*32*2	//W25Q256,前25M字节给FATFS占用	
...
//	return 0;
    ...
    return 
        ((2000+Radio_GlobalVariableStruct.GPS_Dat[0]-1980) << 25) /* Year = 2010 */
    | (Radio_GlobalVariableStruct.GPS_Dat[1] << 21) /* Month = 11 */
    | (Radio_GlobalVariableStruct.GPS_Dat[2] << 16) /* Day = 2 */
    | (Radio_GlobalVariableStruct.GPS_Tim[0] << 11) /* Hour = 15 */
    | (Radio_GlobalVariableStruct.GPS_Tim[1] << 5) /* Min = 0 */
    | (Radio_GlobalVariableStruct.GPS_Tim[2] >> 1) /* Sec = 0 */
    ;
}
//动态分配内存
