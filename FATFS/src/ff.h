...
#define	FA_OPEN_EXISTING	0x00		//只读的方式打开已经存在的文件
#define	FA_CREATE_NEW		0x04		//新建一个文件，如果文件存在，则返回错误
#define	FA_CREATE_ALWAYS	0x08		//新建一个文件，如果文件已经存在则覆盖
#define	FA_OPEN_ALWAYS		0x10		//追加的方式打开文件
