...
//	((FMC_Bank5_6_TypeDef*)FMC_Bank5_6_R_BASE)->SDCMR = tempreg;	//配置寄存器
//	while ((((FMC_Bank5_6_TypeDef*)FMC_Bank5_6_R_BASE)->SDSR & (1 << 5)))//等待指令发送完成 
//	{
//		retry++;
...
void SDRAM_Init(void)
{
	...
	((FMC_Bank5_6_TypeDef*)FMC_Bank5_6_R_BASE)->SDCR[0] = sdctrlreg;	//设置FMC BANK5 SDRAM控制寄存器(BANK5和6用于管理SDRAM).
	...
	((FMC_Bank5_6_TypeDef*)FMC_Bank5_6_R_BASE)->SDTR[0] = sdtimereg;	//设置FMC BANK5 SDRAM时序寄存器
	...
	((FMC_Bank5_6_TypeDef*)FMC_Bank5_6_R_BASE)->SDRTR = 677 << 1;		//设置刷新频率计数器
}
